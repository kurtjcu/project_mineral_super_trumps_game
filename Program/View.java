...
public class View {
    ...
    public String getCardSelection(ArrayList<BaseCard> cardsList){
    ...
    public String getCardSelectionWithPass(ArrayList<BaseCard> cardsList){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Please Select a card ");
        System.out.printf("       | %-20s | %-11s | %-11s | %-11s | %-20s | %-12s | %-10s |%n", "Name", "Card Type", "Hardness", "Spec Grav", "Cleavage", "Crustal Abun", "Value");
    ...
    public String getCardSelectionWithPassAndError(ArrayList<BaseCard> cardsList, String error){
        System.out.println(error);
        return getCardSelectionWithPass(cardsList);
    }
}
