...
public class BottomPanelTrumpSelect extends JPanel {

    Controller controller;

    public BottomPanelTrumpSelect(Controller controller) {
        ...
        this.add(new BottomPanelTopLeft(controller, controller.game.trumpCards.get(0)), BorderLayout.LINE_START);
        this.add(new BottomPanelTopRight(controller), BorderLayout.CENTER);
        this.add(new BottomPanelBottomTrumpSelect(controller), BorderLayout.PAGE_END);

        this.setVisible(true);
    }

    public BottomPanelTrumpSelect(Controller controller, TrumpCard card) {
        this(controller);
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        BottomPanelTrumpSelect bottomPanel = new BottomPanelTrumpSelect(new Controller(new Game()));
